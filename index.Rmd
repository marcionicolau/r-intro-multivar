...
Será utilizado o sofware R `r R.Version()` disponível em (CRAN)[https://cran.r-project.org] e o RStudio `r rstudioapi::versionInfo()` disponível em (RStudio)[https://www.rstudio.com/products/rstudio/download/preview/]
