...
\NormalTok{autoLib =}\StringTok{ }\NormalTok{function(packs) \{}
  ...
  \NormalTok{if(}\KeywordTok{length}\NormalTok{(needInstall)>}\DecValTok{0}\NormalTok{) }\KeywordTok{install.packages}\NormalTok{(needInstall, }\DataTypeTok{dep =} \OtherTok{TRUE}\NormalTok{)}
